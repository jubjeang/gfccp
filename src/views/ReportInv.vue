<template>
    ...
    <div :style="{ 'margin-left': sidebarWidth }" class="row ps-4">
        ...
        <div class="row p-1" style="width: 100%">
          ...
          </h4>-->&nbsp;<h4 class="text-decoration-none text-gray fs-5" @click="DownloadReports"
                    style="cursor: pointer">Download Reports</h4>
            </div>
        </div>
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            <select id="BankType" class="form-select form-select-sm"
                                                ...
                                                <option v-for="data in NewOrder.BankTypeData" :key="data.customerID"
                                                    :value="data.customerID" :selected="data.customerID === BankType">{{
                                                            data.customer_name
                                                    }}
                                                </option>
                            ...
                            <div class="modal-body">
                                <div class="container">
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col ps-4 d-flex">
                                            &nbsp;<select id="BankTypeNew" class="form-select form-select-sm"
                                                style="width:15rem;" v-model="NewOrder.BankTypeNew">
                                                <!-- <option selected="selected" value="">ธนาคาร</option> -->
                                                <option selected="selected" value="">ธนาคาร</option>
                                                <option v-for="data in NewOrder.BankTypeData" :key="data.customerID"
                                                    :value="data.customerID" :selected="data.customerID === BankType">{{
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm" name="OrderCategoryNew"
                                                style="width:15rem;" v-model="NewOrder.OrderCategoryNew"
                                                @click="getOrderType()">
                                                <option value="BankBranch">Bank Branch</option>
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm" id="OrderTypeNew"
                                                style="width:15rem;" v-model="NewOrder.OrderTypeNew"
                                                @click="getBranchAndCash()">
                                                <option value="">Please Select One Type</option>
                                                <option value="Withdraw">Withdraw</option>
                                                <option value="Deposit">Deposit</option>
                                            </select>
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            <datepicker v-model="NewOrder.JobDateNew" id="JobDateNew"
                                    ...
                                    <div class="row p-2">
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm" name="BranchOrigin"
                                                id="BranchOrigin" style="width:15rem;" v-model="NewOrder.BranchOrigin"
                                        ...
                                        <div class="col">
                                            <select class="form-select form-select-sm" name="BranchDest" id="BranchDest"
                                                style="width:15rem;" v-model="NewOrder.BranchDest"
                                                @click="getBranchForCash(NewOrder.BranchDest, 'BranchOrigin')">
...
export default defineComponent({
    ...
    */
        ...
        return {
            searchTerm, table, sidebarWidth, Data_, updateCheckedRows, tableLoadingFinish, getOrderType, DownloadReports
